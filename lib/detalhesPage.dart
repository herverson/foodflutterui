...
class DetalhesPage extends StatefulWidget {
  ...
  DetalhesPage({this.heroTag, this.nomeFood, this.precoFood});
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 10.0),
                            _buildInfoCard('CALÓRIAS', '267', 'CAL'),
                            SizedBox(width: 10.0),
                            _buildInfoCard('VITAMINAS', 'A, B6', 'VIT'),
                            SizedBox(width: 10.0),
